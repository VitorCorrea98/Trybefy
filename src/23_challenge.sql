CREATE TABLE Trybefy.history_play_songs (
  id INT PRIMARY KEY AUTO_INCREMENT,
  user_id INT NOT NULL,
  song_id INT NOT NULL,
  played_at DATETIME NOT NULL,
  FOREIGN KEY(user_id) REFERENCES Trybefy.users(id),
  FOREIGN KEY(song_id) REFERENCES Trybefy.songs(id)
);

INSERT INTO Trybefy.history_play_songs (user_id, song_id, played_at)
  VALUES
