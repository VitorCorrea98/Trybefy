...
CREATE TABLE Trybefy.plans(
  id INT PRIMARY KEY AUTO_INCREMENT,
  name VARCHAR(50) NOT NULL,
  price FLOAT(5,2) NOT NULL
);

INSERT INTO Trybefy.plans(name, price)
  VALUES
    ('Anual', 39.90),
    ('Mensal', 5.90),
    ('Trimestral', 19.90);
...
CREATE TABLE Trybefy.users(
  ...
  FOREIGN KEY (plan_id) REFERENCES Trybefy.plans(id)
);

INSERT INTO users (full_name, email, birthday, active, plan_id)
  VALUES
    ('Pedro', 'pedro@trybefy.com', '1990-01-01', 1, 1),
